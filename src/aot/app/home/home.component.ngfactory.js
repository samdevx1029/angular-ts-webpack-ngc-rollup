...
var _View_HomeComponent_Host0 = (function (_super) {
    ...
    _View_HomeComponent_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('hpt-home', rootSelector, null);
...
export var HomeComponentNgFactory = new import9.ComponentFactory('hpt-home', viewFactory_HomeComponent_Host0, import3.HomeComponent);
...
export function viewFactory_HomeComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_HomeComponent === null)) {
        (renderType_HomeComponent = viewUtils.createRenderComponentType('c:/Users/sshrestha/Source/Repos/Hamilton Plate Tracker Spa/src/app/home/home.component.ts class HomeComponent - inline template', 0, import8.ViewEncapsulation.None, styles_HomeComponent, {}));
    }
