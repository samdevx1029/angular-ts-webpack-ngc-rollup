...
import * as import3 from '../../../app/about/about.component';
...
var _View_AboutComponent_Host0 = (function (_super) {
    ...
    function _View_AboutComponent_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_AboutComponent_Host0, renderType_AboutComponent_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_AboutComponent_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('hpt-about', rootSelector, null);
    ...
    _View_AboutComponent_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.AboutComponent) && (0 === requestNodeIndex))) {
...
function viewFactory_AboutComponent_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_AboutComponent_Host === null)) {
        (renderType_AboutComponent_Host = viewUtils.createRenderComponentType('', 0, import8.ViewEncapsulation.None, [], {}));
    }
    return new _View_AboutComponent_Host0(viewUtils, parentInjector, declarationEl);
}
export var AboutComponentNgFactory = new import9.ComponentFactory('hpt-about', viewFactory_AboutComponent_Host0, import3.AboutComponent);
...
var _View_AboutComponent0 = (function (_super) {
    ...
    function _View_AboutComponent0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_AboutComponent0, renderType_AboutComponent, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
...
export function viewFactory_AboutComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_AboutComponent === null)) {
        (renderType_AboutComponent = viewUtils.createRenderComponentType('c:/Users/sshrestha/Source/Repos/Hamilton Plate Tracker Spa/src/app/about/about.component.ts class AboutComponent - inline template', 0, import8.ViewEncapsulation.None, styles_AboutComponent, {}));
    }
