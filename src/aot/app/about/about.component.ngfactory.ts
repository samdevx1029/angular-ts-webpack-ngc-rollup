...
class _View_AboutComponent_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.selectOrCreateHostElement('hpt-about',rootSelector,(null as any));
...
export const AboutComponentNgFactory:import9.ComponentFactory<import3.AboutComponent> = new import9.ComponentFactory<import3.AboutComponent>('hpt-about',viewFactory_AboutComponent_Host0,import3.AboutComponent);
...
export function viewFactory_AboutComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.AboutComponent> {
  if ((renderType_AboutComponent === (null as any))) { (renderType_AboutComponent = viewUtils.createRenderComponentType('c:/Users/sshrestha/Source/Repos/Hamilton Plate Tracker Spa/src/app/about/about.component.ts class AboutComponent - inline template',0,import8.ViewEncapsulation.None,styles_AboutComponent,{})); }
