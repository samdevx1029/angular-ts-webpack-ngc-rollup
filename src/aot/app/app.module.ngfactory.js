    ...
    Object.defineProperty(AppModuleInjector.prototype, "_LocationStrategy_41", {
        get: function () {
            if ((this.__LocationStrategy_41 == null)) {
                (this.__LocationStrategy_41 = import8.provideLocationStrategy(this.parent.get(import42.PlatformLocation), this.parent.get(import43.APP_BASE_HREF, null), this._ROUTER_CONFIGURATION_40));
            }
